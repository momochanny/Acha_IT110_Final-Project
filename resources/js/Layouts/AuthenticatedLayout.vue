                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('dashboard')" :active="route().current('dashboard')"
                                    class="text-white hover:text-[#FF2D20] transition duration-300 ease-in-out">
                                    Dashboard
                                </NavLink>
                            </div>
                        </div>
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                class="inline-flex items-center rounded-md border border-transparent bg-gray-800 px-3 py-2 text-sm font-medium leading-4 text-white transition duration-150 ease-in-out hover:text-[#FF2D20] focus:outline-none">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('profile.edit')"
                                            class="text-white hover:text-[#FF2D20]">Profile</DropdownLink>
                                        <DropdownLink :href="route('logout')" method="post" as="button"
                                            class="text-white hover:text-[#FF2D20]">
                                            Log Out
                                        </DropdownLink>
                                    </template>
                                </Dropdown>
